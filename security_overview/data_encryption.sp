...
control "security_overview_data_encryption_tri_secret_secure_in_database_replication" {
  ...
  documentation = file("./security_overview/docs/security_overview_data_encryption_tri_secret_secure_in_database_replication.md")
  sql           = query.manual_control.sql
}
control "security_overview_data_encryption_enable_periodic_rekeying" {
  ...
  documentation = file("./security_overview/docs/security_overview_data_encryption_enable_periodic_rekeying.md")
  sql           = query.manual_control.sql
}
...
control "security_overview_data_encryption_use_builtin_encryption_functions" {
  ...
  documentation = file("./security_overview/docs/security_overview_data_encryption_use_builtin_encryption_functions.md")
  sql           = query.manual_control.sql
}
